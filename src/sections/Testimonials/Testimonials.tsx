    ...
    <section id="testimonials">
      <div className="container">
        ...
        <div className="testimonials-wrapper">
          ...
          <p className="testimonial-text">"Muito bom ter um profissional tão atensioso, que nos ouviu e entendeu nossas necessidades na hora da criação do nosso site. O resultado ficou muito moderno e funcional, o Daniel nos proporcionou além de uma visibilidade maior e profissional, um meio de gestão de um processo bem importante no site da nossa empresa. Recomendamos muito, ele fez um excelente trabalho."</p>
